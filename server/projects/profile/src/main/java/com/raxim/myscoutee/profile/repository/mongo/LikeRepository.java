...
public interface LikeRepository extends MongoRepository<Like, UUID>, QuerydslPredicateExecutor<Like> {
        ...
        List<com.raxim.myscoutee.profile.data.dto.rest.Profile> findDoubleById(
                        UUID currUser,
                        UUID selectedUser,
                        int limit,
                        int step,
        ...
        public List<Neo4jLike> findBothAll(String lastTime, double type);
}